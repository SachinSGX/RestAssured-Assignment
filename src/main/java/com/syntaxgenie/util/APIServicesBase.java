...
public abstract class APIServicesBase extends RestUtil {
    ...
    public void setRequest(String baseURI, String basePath, String requestBody) throws JsonProcessingException {
    ...
    public Response makeRequest(String body, Method method) {
    ...
    public Response makeRequest(Headers headers, Method method) {
